...
<r:page titleId="title_condition_has_tag">
...
<h:form acceptcharset="UTF-8" id="has-tag-condition">
...
<tr>
<td><nobr><h:outputText value="#{msg.tag}"/>:</nobr></td>
<td width="98%">
<h:inputText value="#{WizardManager.bean.conditionProperties.tag}" />
</td>
</tr>
<tr><td colspan="2" class="paddingRow"></td></tr>
<tr>
